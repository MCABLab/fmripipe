...
###CHANGE TO YOUR FSL LICENSE FILE 
FSFILE=${EXPERIMENT}/Data/
###ACTUALLY DONT CHANGE THIS 
OUTPUT=${EXPERIMENT}/Analysis/fmriprep/
###CHANGE WHERE YOU WANT THE WORKFILES TO GO
WORK=${EXPERIMENT}/Analysis/fmriprep/work/
...
OUTPUT=${EXPERIMENT}/Analysis/fmriprep
###CHANGE WHERE YOU WANT THE WORKFILES TO GO
WORK=${EXPERIMENT}/Data/MRI_Data/fmriprep/work/
